...
int			conv_from_unicode1(unsigned char*, const int, const WCHAR*, const int, const BOOL);
int			conv_from_unicode2(unsigned char*, const int, const WCHAR*, const int, const BOOL);
int			conv_from_unicode3(unsigned char*, const int, const WCHAR*, const int, const BOOL);

int			jis12conv(const int, const BOOL);
int			jis12winconv(const int, const BOOL);
int			jis3conv(const int, const BOOL);
int			jis3combconv(const int, WCHAR*);
int			jis3combrevconv(int*, const WCHAR*);
...
int			tuikakigou2conv(const int, WCHAR*);
int			tuikakigou2revconv(int*, const WCHAR*);
int			charsize1conv(const int, const BOOL);

void		initrevtable(const int*, int*, const int);
int			comparefortable(const void*, const void*);
int			compareforkigou2code(const void*, const void*);
int			compareforkigou2str(const void*, const void*);
int			compareforwchar(const void *item1, const void *item2);
int			compareforwchar2(const void *item1, const void *item2);
